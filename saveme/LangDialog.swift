...
open class LangDialog: UIView {
    ...
    @objc func deviceOrientationDidChange(_ notification: Notification) {
        ...
        let dialogSize = CGSize(width: 300, height: 120 + kDefaultButtonHeight + kDefaultButtonSpacerHeight)
    ...
    fileprivate func configureLayer() -> UIView {
        let contentFrame = CGRect(x:92, y:40, width: 115, height: 70)
        let result : UIView! = LangDialogView(frame: contentFrame)
        return result
    }
