...
open class SwitchDialog: UIView {
    ...
    private var slayer: SwitchDialogView!
    ...
    open func show(_ title: String,
        ...
        self.slayer.type = self.switchType
        self.slayer.state = self.switchState
        self.slayer.setup()
    ...
    fileprivate func configureLayer() -> SwitchDialogView {
        // 40 label.
        let contentFrame = CGRect(x:0, y:40, width: 300, height: 172)
        let result : SwitchDialogView! = SwitchDialogView(frame: contentFrame)
        return result
    }
