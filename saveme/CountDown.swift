...
//  saveme
//
//  Created by Tibor Sulyok on 2018. 03. 27..
...
extension CountdownLabel {
    ...
    func updateText() {
        ...
        if let countdownAttributedText = countdownAttributedText {
            let attrTextInRange = NSAttributedString(string: formattedText, attributes: countdownAttributedText.attributes as! [String : Any])
