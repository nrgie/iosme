...
open class BloodDialog: UIView {
    ...
    private var slayer: BloodDialogView!
    ...
    fileprivate func configureLayer() -> BloodDialogView {
        let contentFrame = CGRect(x:0, y:40, width: 300, height: 300)
        let result : BloodDialogView! = BloodDialogView(frame: contentFrame)
        return result
    }
