...
open class SignalDialog: UIView {
    ...
    private var slayer: SignalDialogView!
    ...
    fileprivate func configureLayer() -> SignalDialogView {
        // 40 label.
        let contentFrame = CGRect(x:0, y:40, width: 300, height: 172)
        let result : SignalDialogView! = SignalDialogView(frame: contentFrame)
        return result
    }
